...
int main() {
    ...
    vector<Cache> caches;
    /* 4MB Single-Degree */
    caches.emplace_back(Cache(4 * MB, 64, 16, 4, 1 * KB, 1, "4MB-1KB-1"));
    caches.emplace_back(Cache(4 * MB, 64, 16, 4, 2 * KB, 1, "4MB-2KB-1"));
    caches.emplace_back(Cache(4 * MB, 64, 16, 4, 4 * KB, 1, "4MB-4KB-1"));
    caches.emplace_back(Cache(4 * MB, 64, 16, 4, 8 * KB, 1, "4MB-8KB-1"));
    caches.emplace_back(Cache(4 * MB, 64, 16, 4, 16 * KB, 1, "4MB-16KB-1"));
    /* 4MB Multi-Degree (4) */
    caches.emplace_back(Cache(4 * MB, 64, 16, 4, 1 * KB, 4, "4MB-1KB-4"));
    caches.emplace_back(Cache(4 * MB, 64, 16, 4, 2 * KB, 4, "4MB-2KB-4"));
    caches.emplace_back(Cache(4 * MB, 64, 16, 4, 4 * KB, 4, "4MB-4KB-4"));
    caches.emplace_back(Cache(4 * MB, 64, 16, 4, 8 * KB, 4, "4MB-8KB-4"));
    caches.emplace_back(Cache(4 * MB, 64, 16, 4, 16 * KB, 4, "4MB-16KB-4"));
    /* 8MB Single-Degree */
    caches.emplace_back(Cache(8 * MB, 64, 16, 4, 1 * KB, 1, "8MB-1KB-1"));
    caches.emplace_back(Cache(8 * MB, 64, 16, 4, 2 * KB, 1, "8MB-2KB-1"));
    caches.emplace_back(Cache(8 * MB, 64, 16, 4, 4 * KB, 1, "8MB-4KB-1"));
    caches.emplace_back(Cache(8 * MB, 64, 16, 4, 8 * KB, 1, "8MB-8KB-1"));
    caches.emplace_back(Cache(8 * MB, 64, 16, 4, 16 * KB, 1, "8MB-16KB-1"));
    /* 8MB Multi-Degree (4) */
    caches.emplace_back(Cache(8 * MB, 64, 16, 4, 1 * KB, 4, "8MB-1KB-4"));
    caches.emplace_back(Cache(8 * MB, 64, 16, 4, 2 * KB, 4, "8MB-2KB-4"));
    caches.emplace_back(Cache(8 * MB, 64, 16, 4, 4 * KB, 4, "8MB-4KB-4"));
    caches.emplace_back(Cache(8 * MB, 64, 16, 4, 8 * KB, 4, "8MB-8KB-4"));
    caches.emplace_back(Cache(8 * MB, 64, 16, 4, 16 * KB, 4, "8MB-16KB-4"));
    /* == */
